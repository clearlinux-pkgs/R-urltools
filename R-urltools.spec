...
Version  : 1.7.1
Release  : 6
URL      : https://cran.r-project.org/src/contrib/urltools_1.7.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/urltools_1.7.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533308656
